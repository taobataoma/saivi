function demo(url){
	//art.dialog.data('demo', domid);
	art.dialog.open('/index.php?g=User&m=Demo&url='+escape(url),{lock:true,title:'手机预览(Demo)',width:370,height:650,yesText:'关闭',background: '#000',opacity: 0.45});
}
