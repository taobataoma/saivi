...
ChatFloatFactory.prototype = {
    ...
    AjaxRight: function (t, options) {
            ...
            if (responseText) {
                ...
                if (obj) {
                    ...
                    if (obj.succ && obj.weimobid && obj.weimobid.length > 0) {
                        ...
                        e.setCookie('_3GUser_' + options.AId, obj.weimobid, 3600 * 24 * 10000 * 1000);
                    }
                }
            }
        }, function (status) { });
        ...
        var weimobid = "";
        var cookwid = Tools.getCookie("_3GUser_" + options.AId);
        if (cookwid != null) {
            weimobid = cookwid;
        }
    ...
    LocationSource: function (cModel) {
        var ajax = new Ajax(function (responseText, responseXML) {
            if (responseText) {
        ...
        var openid = options.openid ? options.openid : "";
        var param = "AId=" + cModel.aid + "&openid=" + cModel.openid + "&weimobid=" + cModel.weimobid + "&nickname=" + cModel.nickname + "&markname=" + cModel.markname + "&headurl=" + cModel.headurl;
