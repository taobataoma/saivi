...
var tvp=window.tvp||{};var TenVideoPlayer=window.tvp;tvp.lastModify="$Date: 2013-12-19 17:25:20 +0800 (四, 2013-12-19) $";tvp.ver="$Rev: 39229 $";tvp.lastChangedBy="$LastChangedBy: popotang $";tvp.path={base:"http://qzs.qq.com/tencentvideo_v1/js/tvp/",hls_video_cgi:"QZOutputJson={"em":61,"msg":"vid is not valid","s":"f"};",html5_video_cgi:"QZOutputJson={"em":61,"msg":"","s":"f"};"}
...
if(Math.random()<0.1){tvp.report({"cmd":"2551","type":1,"host":h,"url":document.location.href,"ua":navigator.userAgent,"ver":"$Rev: 39229 $","str1":playername,"int1":supportMP4?1:0});}}
...
tvp.Player.prototype=new tvp.BasePlayer();tvp.Player.instance=[];/*  |xGv00|3ea3511e3ba6226803657ffd837205e6 */