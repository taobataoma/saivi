...
function img1(){
    ...
    document.getElementById('text1').style.backgroundColor="#666";
    document.getElementById('text2').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text3').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text4').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text5').style.backgroundColor="rgba(0,0,0,1)";
}
function img2(){
    ...
    document.getElementById('pic4').style.display="none";
    document.getElementById('pic5').style.display="none";
    document.getElementById('text1').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text2').style.backgroundColor="#666";
    document.getElementById('text3').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text4').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text5').style.backgroundColor="rgba(0,0,0,1)";
}
function img3(){
    ...
    document.getElementById('text1').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text2').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text3').style.backgroundColor="#666";
    document.getElementById('text4').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text5').style.backgroundColor="rgba(0,0,0,1)";
}
function img4(){
    ...
    document.getElementById('text2').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text3').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text4').style.backgroundColor="#666";
    document.getElementById('text5').style.backgroundColor="rgba(0,0,0,1)";
}
function img5(){
    document.getElementById('pic1').style.display="none";
    ...
    document.getElementById('text3').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text4').style.backgroundColor="rgba(0,0,0,1)";
    document.getElementById('text5').style.backgroundColor="#666";
}