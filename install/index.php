...
//参数设置
define('SOFT_VERSION', '4.2商业版');
define('SOFT_RELEASE', $version);
define('ROOT_PATH', dirname(__FILE__).'/../');//网站根目录
define('SOFT_NAME', 'SaiVi微信公共平台'.SOFT_VERSION);
define('DBCHARSET','UTF8');//编码 分为 UTF8 GBK
//----------------------语言包
$lang = array(
'license'=>'<div class="license"><h1>赛微微信平台系统安装协议</h1>
                <p>版权所有 (c)2013-2014 保留所有权利。 </p>
				<p>感谢您选择SaiVi微信公共平台基于 PHP + MySQL   的技术开发，全部源码开放。</p>
				<p>为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：</p>
			<strong>一、本授权协议适用且仅适用于 win系统下PHP环境，赛微微信公共平台  官方网址(<a href="http://www.saivi.com.cn" target="_blank">www.saivi.com.cn</a>)的对本授权协议的最终解释权。</strong>
			    <p></p>
			<strong>二、协议许可的权利 </strong>
				<p>1、您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。 </p>
				<p>2、您可以在协议规定的约束和限制范围内修改 SaiVi微信公共平台源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 SaiVi微信公共平台，还是部份栏目使用 SaiVi微信公共平台，在你使用了 SaiVi微信公共平台的网站主页上必须加上 SaiVi微信公共平台  官方网址(<a href="http://saivi.com.cn" target="_blank">www.saivi.com.cn</a>)的链接。</p>
				<p>4、未经官方许可，禁止在 SaiVi微信公共平台  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
				...
				<p><b>版本最新更新：</b> 2014年7月2日</p>
                <p align=right>BY SaiVi微信公共平台</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' SaiVi微信公共平台V'.SOFT_VERSION.' 安装程序',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成：请联系官方授权</p>
		<p class=\'nes\'>1.系统后台地址：<a href=\'http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/admincms.php\' target=\'_blank\'>http://'.$_SERVER['HTTP_HOST'].trim(str_replace(strstr($_SERVER['SCRIPT_NAME'], '/install'),"",$_SERVER['SCRIPT_NAME'])).'/admincms.php</a></p>
...
<meta content="SaiVi信公共平台" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by SaiVi微信公共平台© v4.1 2012-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
