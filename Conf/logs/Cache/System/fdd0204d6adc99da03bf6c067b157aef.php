    ...
    <div class="row">
	  ...
	  <tr>
	    ...
	    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td align='center'><a href="javascript:void(0)" class="btn" onclick="if(confirm('确定删除吗')){location.href='<?php echo U('Token/del/',array('id'=>$vo['id']));?>'}">删除</a><a class="btn" href="<?php echo U('edit',array('id'=>$vo['id']));?>">转移</a>
				</td>
