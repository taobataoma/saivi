<?php /* Smarty version 2.6.18, created on 2013-11-03 20:37:24
         compiled from tpls/ertonglipin/header.html */ ?>
<!doctype html>
...
"><?php echo $this->_tpl_vars['n']['name']; ?>
	...
	<?php endif; ?>
      <li><a href="javascript:void(0)" tppabs="http://anlilp8.3g.tiantis.com/about" data-ajax="false" class="navbtn"><img style="margin-top:12px;height:15px;" src="smarty/templates/tpls/<?php echo $this->_tpl_vars['site']['template']; ?>
/nav.png" alt="导航"></a></li>
    </ul></nav></div>
	<!--xiala nav start-->
	<ul class="navbg">
