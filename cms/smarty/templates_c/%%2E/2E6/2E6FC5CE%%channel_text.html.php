<?php /* Smarty version 2.6.18, created on 2014-03-08 10:57:13
         compiled from 5/ehhbzt1394243285/channel_text.html */ ?>
...
"><?php echo $this->_tpl_vars['c']['title']; ?>
			 ...
			 <?php endif; ?>
				...
				$("div.newslist li:first").css( "border-radius","5px 5px 0 0");
				</script>
        </ul>
      </div>
      <div class="clear"></div>
              <div class="pages ui-grid-b">  <div class="ui-block-a"><span class="left ui-bar-h" id="dis"><img src="smarty/templates/tpls/<?php echo $this->_tpl_vars['site']['template']; ?>
