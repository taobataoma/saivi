...
package
{
	...
	public class Main extends Sprite
	{
		...
		private function init(e:Event = null):void
		{
			...
			ExternalInterface.addCallback('xStop', xStop);
			ExternalInterface.addCallback('xRemove', xRemove);
			
			ExternalInterface.addCallback('xSetEnabled', xSetEnabled);
			
			ExternalInterface.addCallback('xFileSetOptions', xFileSetOptions);
			ExternalInterface.addCallback('xFileStart', xFileStart);
			ExternalInterface.addCallback('xFileStop', xFileStop);
			ExternalInterface.addCallback('xFileRemove', xFileRemove);
			ExternalInterface.addCallback('xFileRequeue', xFileRequeue);
