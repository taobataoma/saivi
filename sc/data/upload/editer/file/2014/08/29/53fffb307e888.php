...
function mainbottom() {
    echo "</div><div style='text-align:center;font-size:13px;color:#999 !important;margin-top:5px;margin-bottom:45px'>"
        ."<a style='color:#999' href='http://www.hezi.be'>抱着盒子的少年</a> FileBox Version 1.6.1 <a href='http://www.hezi.be/t-25' style='color:#999'>View Update</a></div></body>\n"
        ."</html>\n";
    exit;
}
