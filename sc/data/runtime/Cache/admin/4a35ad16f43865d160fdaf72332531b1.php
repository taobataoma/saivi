<?php if (!defined('THINK_PATH')) exit();?><!--添加会员--><div class="dialog_content"><form id="info_form" action="<?php echo u('user/add');?>" method="post"><table width="100%" class="table_form"><tr><th width="100">会员昵称 :</th><td><input type="text" id="username" name="username" class="input-text" /></td></tr><tr><th>会员头像 :</th><td><input type="text" name="img" id="J_img" class="input-text fl mr10" size="30" value="<?php echo ($info["img"]); ?>"><div id="J_upload_img" class="upload_btn"><span><?php echo L('upload');?></span></div><?php if(!empty($info['img'])): ?><span class="attachment_icon J_attachment_icon" file-type="image" file-rel="<?php echo ($img_dir); echo ($info["img"]); ?>"><img src="__STATIC__/images/filetype/image_s.gif" /></span><?php endif; ?></td></tr><tr><th>会员邮箱 :</th><td><input type="text" name="email" id="email" class="input-text" value="<?php echo ($info["email"]); ?>" size="30"></td></tr><tr><th>出生日期 :</th><td><input type="text" name="birthday" id="birthday" class="date input-text" value="<?php echo ($info["birthday"]); ?>" size="27"></td></tr><tr><th>性别 :</th><td><label><input type="radio" name="gender" value="1" <?php if($info["gender"] == 1): ?>checked<?php endif; ?>> 男</label>&nbsp;&nbsp;
				<label><input type="radio" name="gender" value="0" <?php if($info["gender"] == 0): ?>checked<?php endif; ?>> 女</label></td></tr><tr><th>新密码 :</th><td><input type="password" name="password" class="input-text" size="30"></td></tr><tr><th>重复密码 :</th><td><input type="password" name="repassword" class="input-text" size="30"></td></tr><tr><th><?php echo L('enabled');?> :</th><td><label><input type="radio" name="status" value="1" <?php if($info["status"] == 1): ?>checked<?php endif; ?>><?php echo L('yes');?></label>&nbsp;&nbsp;
