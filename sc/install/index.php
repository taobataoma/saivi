...
define('SOFT_NAME', '赛微Saivi™独立用户商城'.SOFT_VERSION);
...
'license'=>'<div class="license"><h1>系统安装协议</h1>
				...
				<p>感谢您选择赛微Saivi™独立用户商城基于 PHP + MySQL   的技术开发，全部源码开放。</p>
			...
			<strong>二、协议许可的权利 </strong>
				...
				<p>2、您可以在协议规定的约束和限制范围内修改 赛微Saivi™独立用户商城源代码或界面风格以适应您的网站要求。 </p>
			...
			<strong>三、协议规定的约束和限制 </strong>
				...
				<p>3、不管你的网站是否整体使用 赛微Saivi™独立用户商城，还是部份栏目使用 微信公共平台，在你使用了 赛微Saivi™独立用户商城的网站主页上必须加上 赛微Saivi™独立用户商城。</p>
				<p>4、未经官方许可，禁止在 赛微Saivi™独立用户商城  的整体或任何部分基础上以发展任何派生版本、修改版本或第三方版本用于重新分发。</p>
			...
			<strong>四、有限担保和免责声明 </strong>
                ...
                <p align=right>BY 赛微Saivi™独立用户商城</p>
</div>',
'agreement_yes' => '我同意，继续安装',
'agreement_no' => '我不同意',
'title_install' => ' 赛微Saivi™独立用户商城V'.SOFT_VERSION.' 安装程序',
...
'install_succ_remark'=>'<p class=\'nest\'>系统安装完成，请登录赛微Saivi™使用。</p>
',
...
<meta content="赛微Saivi™独立用户商城" name="Copyright" />
...
?>
			<div class="footer">
			    <p>Powered by 赛微Saivi™独立用户商城© v2014 2013-2014</p>
				<p>版权所有</p>
			</div>
		</div>
		</div>
